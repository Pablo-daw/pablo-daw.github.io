<?php
require get_parent_theme_file_path( '/inc/sections/customizer-theme-option.php');

require get_parent_theme_file_path( '/inc/sections/section-blog.php');

require get_parent_theme_file_path( '/inc/sections/section-contact.php');

require get_parent_theme_file_path( '/inc/customizer-section-manager.php');

require get_parent_theme_file_path( '/inc/customizer-typography.php');

// live preview
function jewelry_store_customize_preview_js() {
	wp_enqueue_script( 'jewelry-store-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20160816', true );
}
add_action( 'customize_preview_init', 'jewelry_store_customize_preview_js' );

function jewelry_store_fontawesome_icons(){
    return array (
        0 => 'fa-500px',
        1 => 'fa-address-book',
        2 => 'fa-address-book-o',
...
/**
 * Customizer Icon picker function
 */
function jewelry_store_customize_controls_enqueue_scripts(){
...
add_action( 'customize_controls_enqueue_scripts','jewelry_store_customize_controls_enqueue_scripts' );